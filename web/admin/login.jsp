          ...
          <td> 
            ...
            <table width="160" border="0" cellspacing="0" cellpadding="0" align="center">
              ...
              <tr> 
                ...
                <td class="font1" height="36"><font color="#ffffff">密　码</font></td>
                <td> 
              ...
              <tr> 
                ...
                <td align="center">&nbsp; </td>
                <td> 
                  <input type="image" border="0" name="imageField" src="<%=basePath %><%=dir %>/images/bt_login.png" width=100% height=100%>
                </td>
              </tr>
